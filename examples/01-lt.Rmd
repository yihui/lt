...
d = data.frame(
  ...
  Label = c("lt(): make a table", "lt_indent(): child A",
...
lt(d, auto_format = FALSE) |>
  ...
  lt_label(
    Grp = "lt_group()", Width = "lt_width()", Label = "lt_label()",
  ...
  lt_footnote("Alt + Click a table to toggle raw values.", "subtitle") |>
  # lt_move(): explain it via a footnote, since it has no column of its own here
  lt_footnote(
    "lt_move() can reorder columns as desired.",
    "column", "Label"
  ) |>
